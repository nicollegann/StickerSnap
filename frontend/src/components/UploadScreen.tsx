  ...
  return (
    <div className="upload-screen">
      <div className="upload-screen__header">
        ...
        <p className="upload-screen__tagline">Turn any photo into a sticker</p>
      </div>
        ...
        <div className="upload-screen__dropzone-inner">
          <div className="upload-screen__dropzone-icon">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
              ...
              <path d="M8 28h24" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round"/>
              <path d="M8 33h24" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" opacity="0.3"/>
            </svg>
          </div>
      ...
      <div className="upload-screen__examples">
        ...
        <div className="upload-screen__examples-pills">
          {['Pets 🐾', 'People 🙂', 'Objects 📦', 'Food 🍜'].map((item) => (
            <span key={item} className="upload-screen__examples-pill">{item}</span>
          ))}
        </div>
      </div>
